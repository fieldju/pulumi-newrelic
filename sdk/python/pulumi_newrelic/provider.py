    ...
    def __init__(__self__, resource_name, opts=None, account_id=None, admin_api_key=None, api_key=None, api_url=None, cacert_file=None, infrastructure_api_url=None, insecure_skip_verify=None, insights_insert_key=None, insights_insert_url=None, insights_query_url=None, nerdgraph_api_url=None, region=None, synthetics_api_url=None, __props__=None, __name__=None, __opts__=None):
        ...
        if opts.id is None:
            ...
            if admin_api_key is None:
                admin_api_key = _utilities.get_env('NEW_RELIC_ADMIN_API_KEY')
            __props__['admin_api_key'] = admin_api_key
            if api_key is None:
                api_key = _utilities.get_env('NEW_RELIC_API_KEY')
            ...
            if cacert_file is None:
                cacert_file = _utilities.get_env('NEW_RELIC_API_CACERT')
            ...
            if insecure_skip_verify is None:
                insecure_skip_verify = _utilities.get_env_bool('NEW_RELIC_API_SKIP_VERIFY')
            ...
            if insights_insert_key is None:
                insights_insert_key = _utilities.get_env('NEW_RELIC_INSIGHTS_INSERT_KEY')
            __props__['insights_insert_key'] = insights_insert_key
            if insights_insert_url is None:
                insights_insert_url = (_utilities.get_env('NEW_RELIC_INSIGHTS_INSERT_URL') or 'https://insights-collector.newrelic.com/v1/accounts')
            __props__['insights_insert_url'] = insights_insert_url
            if insights_query_url is None:
                insights_query_url = (_utilities.get_env('NEW_RELIC_INSIGHTS_QUERY_URL') or 'https://insights-api.newrelic.com/v1/accounts')
